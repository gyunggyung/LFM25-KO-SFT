...
RUN_ID="${RUN_ID:-$(date -u +%Y%m%dT%H%M%SZ)_stage1_8k_terminal_toolbench}"
...
DATASET_PATH="${DATASET_PATH:-$DATA_ROOT/prepared/merged/20260628_sft_prep_v2_stage1_8k_terminal_toolbench}"
