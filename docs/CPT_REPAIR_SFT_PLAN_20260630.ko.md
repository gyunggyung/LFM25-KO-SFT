...
권장 full preprocess 목표는 200M tokens다. 실제 학습 후보 범위는 100M-300M tokens다.
...
| full raw repair JSONL 생성 | 1-3분 |
| preservation source export | 20-60분 |
| 200M-token LFM tokenization | 30-90분 |
| full validation/report 생성 | 1-5분 |
| 문서/모델카드 갱신 | 10-20분 |

나중에 명시적으로 학습 승인이 나면, 200M tokens / 4k / 8 H200 / effective batch
128 기준으로 2-4시간 범위를 예상한다. 단, 이 문서 작성 시점에는 학습하지 않는다.
